...
\blankscreen{
        ...
        2D paper surface - pages, rows, columns\textCR
        Hierarchy becomes cumbersome\textCR
        Simplification and Compromise - lossy compression\textCR
        Database tables much the same
}
