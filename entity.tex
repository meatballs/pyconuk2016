    ...
    \begin{center}
        \resizebox{10cm}{!}{
            \begin{tikzpicture}
                ...
                \node(real_mx5)[real] at (4){\includegraphics[width=3cm]{images/mx5}};

                \node(real_mondeo)[real] at (7){\includegraphics[width=3cm]{images/mondeo}};
    ...
    \begin{center}
        \resizebox{10cm}{!}{
            \begin{tikzpicture}
                ...
                \node<2->(car) at (1)[substance]{Car};
                \draw<2->(my_mx5.north) -- (car.south);
                \draw<2->(my_mondeo.north) -- (car.south);

                \node<3->(mx5_attr)[attribute, anchor=north west] at (abc123.south west) {Mazda MX5};
                \node<3->(mondeo_attr)[attribute, anchor=north west] at (xyz789.south west) {Ford Mondeo};
