        ...
        \resizebox{10cm}{!}{
            \begin{tikzpicture}
                \node (car) at (0, 9) {};
                    ...
                    \node (mondeo) at (3, 6){};
                        \node (my_mondeo) at (3, 3){};
                            \node (real_mondeo) at (3, 0){};

                \node (dwelling) at (9, 9){};
                    \node (house) at (9, 6){};
                        \node(my_house) at (9, 3){};
                            \node(real_house) at (9, 0){};


                \node<1->(1)[real] at (real_mx5){\includegraphics[width=3cm]{images/Psion_Series_3a}};

                \node<2->(2)[real] at (real_mondeo){\includegraphics[width=3cm]{images/Psion_Series_3a}};

                \node<3->(3)[real] at (real_house){\includegraphics[width=3cm]{images/Psion_Series_3a}};

                \node<4->(4) at (my_mx5)[primary]{My MX5};
                \draw<4->(1.north)--(4.south);

                \node<5->(5) at (my_mondeo)[primary]{My Mondeo};
                \draw<5->(2.north) -- (5.south);

                \node<6->(6) at (my_house)[primary]{My House};
                \draw<6->(3.north) -- (6.south);

                \node<7->(silver)[attribute, xshift=0.5cm] at (4.east){Silver};
                \node<7->(abc123)[attribute, anchor=north west] at (silver.south west){ABC 123};

                \node<8->(grey)[attribute, xshift=0.8cm] at (5.east){Grey};
                \node<8->(xyz789)[attribute, anchor=north west] at (grey.south west){XYZ 789};

                \node<9->(detached)[attribute, xshift=0.8cm] at (6.east){Detached};
